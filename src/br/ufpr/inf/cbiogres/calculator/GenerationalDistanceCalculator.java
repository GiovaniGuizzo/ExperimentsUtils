package br.ufpr.inf.cbiogres.calculator;

import br.ufpr.inf.cbiogres.extensions.indicator.GenerationalDistance;
import jmetal.core.SolutionSet;

/**
 * This class was designed to help the calculation of Generational Distance (GD). The idea is to add all available Pareto fronts into an <b>internal population</b>, in order to perform an exact normalization. This internal population is used for assessing the max and min values for the normalization. It is useful when you don't know what are these values and must use the max known and min known values.
 * <br/>
 * <br/>
 * If the intention is to compare the fronts A, B and C, then the addParetoFront() method must be invoked three times giving A, B and then C as input.
 */
public class GenerationalDistanceCalculator extends Calculator {
    ...
    /**
     * Calculates the GD for the given front. This method uses the internal population as basis for assessing the min and max values in the normalization.
     *
    ...
    /**
     * Calculates the IGD for the given front. This method uses the internal population as basis for assessing the min and max values in the normalization.
     *
