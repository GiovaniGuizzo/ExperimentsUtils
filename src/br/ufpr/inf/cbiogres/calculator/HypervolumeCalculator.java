...
import br.ufpr.inf.cbiogres.extensions.indicator.Hypervolume;
import jmetal.core.SolutionSet;

/**
 * This class was designed to help the calculation of Hypervolume. The idea is to add all available Pareto fronts into an <b>internal population</b>, in order to perform an exact normalization. This internal population is used for assessing the max and min values for the normalization. It is useful when you don't know what are these values and must use the max known and min known values.
 * <br/>
 * <br/>
...
public class HypervolumeCalculator extends Calculator {
    ...
    /**
     * Calculates the hypervolume for the given front. This method uses the internal population as basis for assessing the min and max values in the normalization.
     *
